"""
Proyecto final, CiberCel.

El programa presenta un menú con las siguientes opciones: Muestra los productos con sus detalles, 
Muestra el código del producto, nombre, marca, precio, stock, color y características de cada producto en la tienda.

Muestra información breve del producto: Muestra el código del producto, nombre, precio y cantidad
disponible de cada producto en la tienda.

Se Busca el producto por código: Permite al usuario ingresar un código de producto y muestra la información detallada
de ese producto.

Al realizar la compra: Permite al usuario agregar productos al carrito de compras.
...
class CarritoCompras:
    ...
    def Menu(self):
        while True:
            print("""Bienvenido a CyberCel , seleccione con un numero la opcion que desea:
...
""")
            ...
            if opcion == "1":
                ...
                print("¡Muchas gracias! lo esperamos pronto\n")
                break
            else:
